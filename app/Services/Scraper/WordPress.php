...
class WordPress implements ScraperInterface
{

    /**
     * The Internal identifier of this 
     * source of news (Linux Tech Lab)
     */
     ...
     * Class contructor
     */ 
    public function __construct(string $baseUrl, int $sourceId)
    {
    ...
    {
        return $this->sourceId ?? self::SOURCE_NEWS_ID;
    }
    ...
    private function _prepareResponse($article)
    {
        return [
            ...
            'image'      => $article['jetpack_featured_media_url'] ?? null,
